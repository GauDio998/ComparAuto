...
const BentoCardGrid: React.FC<BentoCardGridProps> = ({ children, gridRef }) => (
  <div
    className="bento-section max-w-7xl mx-auto relative px-4"
    ref={gridRef}
  >
    {children}
  </div>
...
// Componente principale MagicBento
const MagicBento: React.FC<MagicBentoProps> = ({
  ...
  return (
    <section className="py-24 px-4 relative bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950">
      {/* Background decorativo uguale a Features */}
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto dark:text-slate-300">
            ...
            , con strumenti avanzati di analisi.
          </p>
        </motion.div>
        ...
        <BentoCardGrid gridRef={gridRef}>
          <div className="card-responsive">
            {cardData.map((card, index) => {
              const baseClassName = `card flex flex-col justify-between relative w-full p-6 rounded-xl border border-slate-200/80 font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-xl bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md dark:bg-slate-800/80 dark:border-slate-700/80 ${enableBorderGlow ? "card--border-glow" : ""
                }`;
              ...
              if (enableStars) {
                return (
                  ...
                  >
                    <div className="card__header flex justify-between gap-3 relative text-indigo-700 dark:text-indigo-300">
                      <span className="card__label text-base font-medium">{card.label}</span>
                    </div>
                    <div className="card__content flex flex-col relative text-indigo-700 dark:text-indigo-300">
                      <h3
                        className={`card__title font-bold text-lg mb-2 ${textAutoHide ? "text-clamp-1" : ""}`}
                      >
                        {card.title}
                      </h3>
                      <p
      ...
      <style>
        {`
          ...
          /* CSS per grid pattern come Features */
